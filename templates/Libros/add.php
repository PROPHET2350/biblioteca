        ...
        <div class="form-horizontal">
            <div class="card-body card-block">
                <div class="row form-group">
                    <div class="col col-md-12">
                        <div class="input-group">
                            <input type="text" id="input1-group3" required name="author" placeholder="Author" value="" class="form-control">
                ...
                <div class="row form-group">
                    <div class="col col-md-12">
                        <div class="input-group">
                            <input type="text" id="input2-group22" required name="title" placeholder="Title" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-12">
                        <div class="input-group">
                            <input type="text" id="input3-group1" required name="isbn" placeholder="ISBN" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-12">
                        <div class="input-group">
                            <input type="text" id="input3-group4" required name="precio" placeholder="price" class="form-control">
                        </div>
                    </div>
                </div>
